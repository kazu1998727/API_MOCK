...
export const posts = [
  {
    ...
    userId: 1,
    title: "Reactの基本",
    body: "Reactコンポーネントの作り方について",
  },
  {
    id: 2,
    userId: 1,
    title: "Hooksの使い方",
    body: "useState、useEffectなどの解説",
  },
  {
    id: 3,
    userId: 2,
...
export const comments = [
  { id: 1, postId: 1, name: "匿名ユーザー", body: "とても参考になりました！" },
  {
    ...
    postId: 1,
    name: "React初心者",
    body: "もう少し詳しく説明してほしいです",
  },
  {
    id: 3,
    postId: 2,
    name: "開発者A",
    body: "カスタムフックについても知りたいです",
  },
